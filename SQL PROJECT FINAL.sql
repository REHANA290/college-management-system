...
('9','2','1','B');
 ...
 SELECT * FROM department
 JOIN teacher ON teacher.department_id = department.department_id



 SELECT * FROM enrollement
 LEFT JOIN course ON enrollement.course_id = course.course_id

SELECT * FROM student
RIGHT OUTER JOIN enrollement ON student.student_id = enrollement.student_id
INNER JOIN course ON enrollement.course_id = course.course_id 
